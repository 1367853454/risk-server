...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from    = "headstartServer@localhost";
    ...
    public static class Swagger {
        ...
        private String title       = "AssetShowAsServer API";

        private String description = "AssetShowServer API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String  prefix  = "headstartServer";
