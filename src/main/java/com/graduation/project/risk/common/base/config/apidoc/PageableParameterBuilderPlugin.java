        ...
        if (type != null && Pageable.class.isAssignableFrom(type)) {
            ...
            List<Parameter> parameters = newArrayList(
                    context.parameterBuilder()
                            .parameterType("queryGroup").name("page").modelRef(intModel)
                            .description("Page number of the requested page")
                            .build(),
                    context.parameterBuilder()
                            .parameterType("queryGroup").name("size").modelRef(intModel)
                            .description("Size of a page")
                            .build(),
                    context.parameterBuilder()
                            .parameterType("queryGroup").name("sort").modelRef(stringModel).allowMultiple(true)
